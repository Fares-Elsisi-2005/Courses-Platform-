        ...
        <Box maxWidth={"500px"} p="20px" bgcolor={colors.primary[200]} borderRadius={"10px"}>
            ...
            {({
                ...
                sx={{backgroundColor:colors.primary[100]}}
                    ...
                    onChange={handleChange}
                    onBlur={handleBlur}
                    error={!!touched.previousPassword && !!errors.previousPassword}
                ...
                {touched.profilePic && errors.profilePic && (
                    ...
                    {errors.profilePic}
                        ...
                        {/* Submit */}
                        <Button type="submit" variant="contained" sx={{  backgroundColor: colors.purple[500], width: "fit-content", color: colors.white[100], margin: "20px 0" }}>Update Profile</Button>
